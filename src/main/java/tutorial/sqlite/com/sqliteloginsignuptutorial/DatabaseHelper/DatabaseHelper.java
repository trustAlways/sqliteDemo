package tutorial.sqlite.com.sqliteloginsignuptutorial.DatabaseHelper;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private String CREATE_USER_TABLE = "CREATE TABLE " + TABLE_USER + "(" + COLUMN_USER_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
            + COLUMN_USER_NAME + " TEXT,"+ COLUMN_USER_EMAIL + " TEXT," + COLUMN_USER_PASSWORD + " TEXT," + COLUMN_USER_IMAGE + " BLOB NOT NULL" +")";
